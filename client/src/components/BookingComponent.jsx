export default function BookingComponent({ booking }) {
  return (
    <div
      className="w-full flex gap-4 border bg-background h-[250px] rounded-3xl overflow-hidden ease-linear transition-all duration-300 cursor-pointer "
      key={booking.id}
    >
      ...
      <div className="py-2 flex pl-6 flex-col h-full items-start justify-center gap-4 my-auto">
        ...
        <div className="text-xl font-medium flex gap-2 items-center font-semibold">
          <span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
